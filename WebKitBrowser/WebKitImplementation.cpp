...
--------------------------------------------------------------------------------------------------- */
    ...
    public:
        ...
        public:
            ...
            {
                Add(_T("browserversion"), &BrowserVersion);
        ...
        public:
            Core::JSON::String BrowserVersion;
    ...
    private:
        ...
        uint32_t Worker() override
        {
            ...
            if (_config.UserAgent.IsSet() == true && _config.UserAgent.Value().empty() == false) {
                ...
                webkit_settings_set_user_agent_with_application_details(preferences, "WPE", _config.BrowserVersion.Value().c_str());
