        ...
        private:
            ...
            private:
		      ...
		      size_t clearContentInfoTraceTotalCount = 0;
                    CDMi::EncryptionScheme encScheme = CDMi::AesCtr_Cenc;
            ...
            public:
                ...
                {
                    uint32_t size = challengeSize;
                    Exchange::OCDM_RESULT res = (Exchange::OCDM_RESULT)_mediaKeySessionExt->GetChallengeDataExt(challenge, size, isLDL);
                    challengeSize = size;
                    return res;
                }
