...
XCast::XCast() : m_apiVersionNumber(1), m_isDynamicRegistrationsRequired(false), m_lockedRtServiceApi(this, Utils::Synchro::ApiLocks<XCast>::mtx)
{
    InitializeIARM();
...
const string XCast::Initialize(PluginHost::IShell* /* service */)
{
    ...
    _rtConnector->setService(&m_lockedRtServiceApi);
    if (XCast::isCastEnabled)
    {
