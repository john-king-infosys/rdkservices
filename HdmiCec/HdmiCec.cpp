...
#ifdef HDMICEC_SEND_ACTIVE_SOURCE_COMMAND
                IARM_CHECK( Utils::Synchro::RegisterLockedIarmEventHandler<HdmiCec>(IARM_BUS_CECMGR_NAME, IARM_BUS_CECMGR_EVENT_DEVICEREADY, cbCecDeviceReady) );
                IARM_CHECK( Utils::Synchro::RegisterLockedIarmEventHandler<HdmiCec>(IARM_BUS_DSMGR_NAME, IARM_BUS_DSMGR_EVENT_RX_SENSE, dsRxSenseEventHandler) );
#endif
...
#ifdef HDMICEC_SEND_ACTIVE_SOURCE_COMMAND
                IARM_CHECK( Utils::Synchro::RemoveLockedEventHandler<HdmiCec>(IARM_BUS_CECMGR_NAME, IARM_BUS_CECMGR_EVENT_DEVICEREADY, cbCecDeviceReady) );
                IARM_CHECK( Utils::Synchro::RemoveLockedEventHandler<HdmiCec>(IARM_BUS_DSMGR_NAME, IARM_BUS_DSMGR_EVENT_RX_SENSE, dsRxSenseEventHandler) );
#endif
            }
        }
